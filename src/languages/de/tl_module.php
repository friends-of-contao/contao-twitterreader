...
$GLOBALS['TL_LANG']['tl_module']['twitterEmbedFirstMedia']        = array('Erstes Medium einbetten', 'Soll das erste Medium automatisch eingebettet werden?');
$GLOBALS['TL_LANG']['tl_module']['twitterEmbedFirstMediaSize']    = array('Breite und Höhe des eingebetteten Mediums', 'Hier können Sie die Abmessungen des Mediums festlegen.');
